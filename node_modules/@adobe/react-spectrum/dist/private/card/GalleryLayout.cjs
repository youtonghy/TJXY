...
var $gJap1$reactstatelyuseVirtualizerState = require("react-stately/useVirtualizerState");
...
$parcel$export(module.exports, "GalleryLayout", function () { return $f3beb99b6cf5ce50$export$8e52095834484b61; });
// @ts-nocheck
/*
...
const $f3beb99b6cf5ce50$var$DEFAULT_OPTIONS = {
    S: {
        idealRowHeight: 112,
        minItemSize: new (0, $gJap1$reactstatelyuseVirtualizerState.Size)(96, 96),
        itemSpacing: new (0, $gJap1$reactstatelyuseVirtualizerState.Size)(8, 16),
        itemPadding: 24,
        dropSpacing: 50,
        margin: 8
    },
...
class $f3beb99b6cf5ce50$export$8e52095834484b61 extends (0, $b9ec4ce2ddaeda0a$exports.BaseLayout) {
    constructor(options = {}){
        super(options);
        let cardSize = 'L';
        this.idealRowHeight = options.idealRowHeight || $f3beb99b6cf5ce50$var$DEFAULT_OPTIONS[cardSize].idealRowHeight;
        this.itemSpacing = options.itemSpacing || $f3beb99b6cf5ce50$var$DEFAULT_OPTIONS[cardSize].itemSpacing;
        this.itemPadding = options.itemPadding != null ? options.itemPadding : $f3beb99b6cf5ce50$var$DEFAULT_OPTIONS[cardSize].itemPadding[this.scale];
        this.minItemSize = options.minItemSize || $f3beb99b6cf5ce50$var$DEFAULT_OPTIONS[cardSize].minItemSize;
        this.threshold = options.threshold || 1;
        this.margin = options.margin != null ? options.margin : $f3beb99b6cf5ce50$var$DEFAULT_OPTIONS[cardSize].margin;
    }
    get layoutType() {
        return 'gallery';
    }
   ...
   */ _distributeWidths(widths) {
    ...
    buildCollection() {
        ...
        if (availableWidth > 0) {
            ...
            let partition = $f3beb99b6cf5ce50$var$linearPartition(weightedRatios, rows);
            let index = 0;
            for (let row of partition){
                ...
                for(let j = index; j < index + row.length; j++){
                    ...
                    let rect = new (0, $gJap1$reactstatelyuseVirtualizerState.Rect)(x, y, itemWidth, itemHeight);
                    let layoutInfo = new (0, $gJap1$reactstatelyuseVirtualizerState.LayoutInfo)(node.type, node.key, rect);
            ...
            if (this.isLoading) {
                ...
                let rect = new (0, $gJap1$reactstatelyuseVirtualizerState.Rect)(0, loaderY, visibleWidth, loaderHeight);
                let loader = new (0, $gJap1$reactstatelyuseVirtualizerState.LayoutInfo)('loader', 'loader', rect);
                this.layoutInfos.set('loader', loader);
                y = loader.rect.maxY;
            }
            if (this.collection.size === 0 && !this.isLoading) {
                let rect = new (0, $gJap1$reactstatelyuseVirtualizerState.Rect)(0, 0, visibleWidth, visibleHeight);
                let placeholder = new (0, $gJap1$reactstatelyuseVirtualizerState.LayoutInfo)('placeholder', 'placeholder', rect);
                this.layoutInfos.set('placeholder', placeholder);
                y = placeholder.rect.maxY;
            }
        }
        this.contentSize = new (0, $gJap1$reactstatelyuseVirtualizerState.Size)(visibleWidth, y);
    }
}
// https://www8.cs.umu.se/kurser/TDBA77/VT06/algorithms/BOOK/BOOK2/NODE45.HTM
function $f3beb99b6cf5ce50$var$linearPartition(seq, k) {
    let n = seq.length;
    if (k <= 0) return [];
...
//# sourceMappingURL=GalleryLayout.cjs.map
