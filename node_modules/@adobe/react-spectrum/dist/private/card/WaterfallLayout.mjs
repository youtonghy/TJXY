...
import {getFirstItem as $4R933$getFirstItem, getChildNodes as $4R933$getChildNodes} from "react-stately/private/collections/getChildNodes";
import {Size as $4R933$Size, Rect as $4R933$Rect, LayoutInfo as $4R933$LayoutInfo} from "react-stately/useVirtualizerState";
...
class $b2f9202e20b8e5b3$export$e9f7cda058ba8df8 extends (0, $47544ce7688f5862$export$64943d2e59d72a29) {
    constructor(options = {}){
        ...
        super(options);
        this.minItemSize = options.minItemSize || new (0, $4R933$Size)(240, 136);
        this.maxItemSize = options.maxItemSize || new (0, $4R933$Size)(Infinity, Infinity);
        this.margin = options.margin != null ? options.margin : 24;
        this.minSpace = options.minSpace || new (0, $4R933$Size)(18, 18);
    ...
    buildCollection(invalidationContext) {
        ...
        for (let node of this.collection){
            ...
            let rect = new (0, $4R933$Rect)(x, y, itemWidth, height);
            let layoutInfo = new (0, $4R933$LayoutInfo)(node.type, key, rect);
        ...
        if (this.isLoading) {
            ...
            let rect = new (0, $4R933$Rect)(0, loaderY, this.virtualizer.visibleRect.width, loaderHeight);
            let loader = new (0, $4R933$LayoutInfo)('loader', 'loader', rect);
            this.layoutInfos.set('loader', loader);
            y = loader.rect.maxY;
        }
        if (this.collection.size === 0 && !this.isLoading) {
            let rect = new (0, $4R933$Rect)(0, 0, this.virtualizer.visibleRect.width, this.virtualizer.visibleRect.height);
            let placeholder = new (0, $4R933$LayoutInfo)('placeholder', 'placeholder', rect);
            this.layoutInfos.set('placeholder', placeholder);
            y = placeholder.rect.maxY;
        }
        this.contentSize = new (0, $4R933$Size)(this.virtualizer.visibleRect.width, y);
    }
    ...
    getClosestRight(key) {
        ...
        let rect = new (0, $4R933$Rect)(layoutInfo.rect.maxX + 1, layoutInfo.rect.y, layoutInfo.rect.width + this.horizontalSpacing, layoutInfo.rect.height);
        key = this._findClosest(layoutInfo.rect, rect)?.key;
        if (key == null) {
            rect = new (0, $4R933$Rect)(layoutInfo.rect.maxX + 1, 0, layoutInfo.rect.width + this.horizontalSpacing, this.virtualizer.contentSize.height);
            key = this._findClosest(layoutInfo.rect, rect)?.key;
        }
        let item = this.collection.getItem(key);
        return (0, $4R933$getFirstItem)((0, $4R933$getChildNodes)(item, this.collection))?.key;
    }
    getClosestLeft(key) {
        let layoutInfo = this.getLayoutInfo(key);
        ...
        let rect = new (0, $4R933$Rect)(layoutInfo.rect.x - layoutInfo.rect.width - this.horizontalSpacing - 1, layoutInfo.rect.y, layoutInfo.rect.width + this.horizontalSpacing, layoutInfo.rect.height);
        key = this._findClosest(layoutInfo.rect, rect)?.key;
        if (key == null) {
            rect = new (0, $4R933$Rect)(layoutInfo.rect.x - layoutInfo.rect.width - this.horizontalSpacing - 1, 0, layoutInfo.rect.width + this.horizontalSpacing, this.virtualizer.contentSize.height);
            key = this._findClosest(layoutInfo.rect, rect)?.key;
        }
        let item = this.collection.getItem(key);
        return (0, $4R933$getFirstItem)((0, $4R933$getChildNodes)(item, this.collection))?.key;
...
export {$b2f9202e20b8e5b3$export$e9f7cda058ba8df8 as WaterfallLayout};
