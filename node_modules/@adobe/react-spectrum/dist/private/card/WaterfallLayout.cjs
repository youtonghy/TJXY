...
var $6SgqS$reactstatelyprivatecollectionsgetChildNodes = require("react-stately/private/collections/getChildNodes");
var $6SgqS$reactstatelyuseVirtualizerState = require("react-stately/useVirtualizerState");
...
$parcel$export(module.exports, "WaterfallLayout", function () { return $a9e1e9beb02a9157$export$e9f7cda058ba8df8; });
// @ts-nocheck
/*
...
class $a9e1e9beb02a9157$export$e9f7cda058ba8df8 extends (0, $b9ec4ce2ddaeda0a$exports.BaseLayout) {
    constructor(options = {}){
        ...
        super(options);
        this.minItemSize = options.minItemSize || new (0, $6SgqS$reactstatelyuseVirtualizerState.Size)(240, 136);
        this.maxItemSize = options.maxItemSize || new (0, $6SgqS$reactstatelyuseVirtualizerState.Size)(Infinity, Infinity);
        this.margin = options.margin != null ? options.margin : 24;
        this.minSpace = options.minSpace || new (0, $6SgqS$reactstatelyuseVirtualizerState.Size)(18, 18);
    ...
    buildCollection(invalidationContext) {
        ...
        for (let node of this.collection){
            ...
            let rect = new (0, $6SgqS$reactstatelyuseVirtualizerState.Rect)(x, y, itemWidth, height);
            let layoutInfo = new (0, $6SgqS$reactstatelyuseVirtualizerState.LayoutInfo)(node.type, key, rect);
        ...
        if (this.isLoading) {
            ...
            let rect = new (0, $6SgqS$reactstatelyuseVirtualizerState.Rect)(0, loaderY, this.virtualizer.visibleRect.width, loaderHeight);
            let loader = new (0, $6SgqS$reactstatelyuseVirtualizerState.LayoutInfo)('loader', 'loader', rect);
            this.layoutInfos.set('loader', loader);
            y = loader.rect.maxY;
        }
        if (this.collection.size === 0 && !this.isLoading) {
            let rect = new (0, $6SgqS$reactstatelyuseVirtualizerState.Rect)(0, 0, this.virtualizer.visibleRect.width, this.virtualizer.visibleRect.height);
            let placeholder = new (0, $6SgqS$reactstatelyuseVirtualizerState.LayoutInfo)('placeholder', 'placeholder', rect);
            this.layoutInfos.set('placeholder', placeholder);
            y = placeholder.rect.maxY;
        }
        this.contentSize = new (0, $6SgqS$reactstatelyuseVirtualizerState.Size)(this.virtualizer.visibleRect.width, y);
    }
    ...
    getClosestRight(key) {
        ...
        return (0, $6SgqS$reactstatelyprivatecollectionsgetChildNodes.getFirstItem)((0, $6SgqS$reactstatelyprivatecollectionsgetChildNodes.getChildNodes)(item, this.collection))?.key;
    }
    getClosestLeft(key) {
        let layoutInfo = this.getLayoutInfo(key);
