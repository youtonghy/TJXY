...
import $3A0G8$react, {createContext as $3A0G8$createContext, useContext as $3A0G8$useContext} from "react";
...
const $78389b17485c731f$export$48a76196cafe3b93 = /*#__PURE__*/ (0, $3A0G8$react).forwardRef(function Resizer(props, ref) {
    ...
    let { inputProps: inputProps, resizerProps: resizerProps, isMouseResizing: isMouseResizing } = (0, $3A0G8$useTableColumnResize)((0, $3A0G8$mergeProps)(props, {
