...
export declare const Tooltip: (({ children, closeDelay, delay, shouldSkipAnimation, ...props }: import("./tooltip").TooltipRootProps) => import("react/jsx-runtime").JSX.Element) & {
    Root: ({ children, closeDelay, delay, shouldSkipAnimation, ...props }: import("./tooltip").TooltipRootProps) => import("react/jsx-runtime").JSX.Element;
    Trigger: <E extends keyof React.JSX.IntrinsicElements = "div">({ children, className, ...props }: import("./tooltip").TooltipTriggerProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof import("./tooltip").TooltipTriggerProps<E>>) => import("react/jsx-runtime").JSX.Element;
