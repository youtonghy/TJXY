...
import {getFirstItem as $IlHAI$getFirstItem, getChildNodes as $IlHAI$getChildNodes} from "react-stately/private/collections/getChildNodes";
import {Rect as $IlHAI$Rect, LayoutInfo as $IlHAI$LayoutInfo, Size as $IlHAI$Size} from "react-stately/useVirtualizerState";
...
class $5ec1ec2c9d2aba1a$export$e9f7cda058ba8df8 extends (0, $7c753442ee8aa648$export$64943d2e59d72a29) {
    get layoutType() {
        return 'waterfall';
    }
    buildCollection(invalidationContext) {
        ...
        for (let node of this.collection){
            ...
            let rect = new (0, $IlHAI$Rect)(x, y, itemWidth, height);
            let layoutInfo = new (0, $IlHAI$LayoutInfo)(node.type, key, rect);
        ...
        if (this.isLoading) {
            ...
            let rect = new (0, $IlHAI$Rect)(0, loaderY, this.virtualizer.visibleRect.width, loaderHeight);
            let loader = new (0, $IlHAI$LayoutInfo)('loader', 'loader', rect);
            this.layoutInfos.set('loader', loader);
            y = loader.rect.maxY;
        }
        if (this.collection.size === 0 && !this.isLoading) {
            let rect = new (0, $IlHAI$Rect)(0, 0, this.virtualizer.visibleRect.width, this.virtualizer.visibleRect.height);
            let placeholder = new (0, $IlHAI$LayoutInfo)('placeholder', 'placeholder', rect);
            this.layoutInfos.set('placeholder', placeholder);
            y = placeholder.rect.maxY;
        }
        this.contentSize = new (0, $IlHAI$Size)(this.virtualizer.visibleRect.width, y);
    }
    ...
    getClosestRight(key) {
        ...
        let rect = new (0, $IlHAI$Rect)(layoutInfo.rect.maxX + 1, layoutInfo.rect.y, layoutInfo.rect.width + this.horizontalSpacing, layoutInfo.rect.height);
        ...
        if (key == null) {
            ...
            rect = new (0, $IlHAI$Rect)(layoutInfo.rect.maxX + 1, 0, layoutInfo.rect.width + this.horizontalSpacing, this.virtualizer.contentSize.height);
        ...
        return (_getFirstItem = (0, $IlHAI$getFirstItem)((0, $IlHAI$getChildNodes)(item, this.collection))) === null || _getFirstItem === void 0 ? void 0 : _getFirstItem.key;
    }
    getClosestLeft(key) {
        var _this__findClosest, _getFirstItem;
        let layoutInfo = this.getLayoutInfo(key);
        ...
        let rect = new (0, $IlHAI$Rect)(layoutInfo.rect.x - layoutInfo.rect.width - this.horizontalSpacing - 1, layoutInfo.rect.y, layoutInfo.rect.width + this.horizontalSpacing, layoutInfo.rect.height);
        key = (_this__findClosest = this._findClosest(layoutInfo.rect, rect)) === null || _this__findClosest === void 0 ? void 0 : _this__findClosest.key;
        if (key == null) {
            var _this__findClosest1;
            rect = new (0, $IlHAI$Rect)(layoutInfo.rect.x - layoutInfo.rect.width - this.horizontalSpacing - 1, 0, layoutInfo.rect.width + this.horizontalSpacing, this.virtualizer.contentSize.height);
            key = (_this__findClosest1 = this._findClosest(layoutInfo.rect, rect)) === null || _this__findClosest1 === void 0 ? void 0 : _this__findClosest1.key;
        }
        let item = this.collection.getItem(key);
        return (_getFirstItem = (0, $IlHAI$getFirstItem)((0, $IlHAI$getChildNodes)(item, this.collection))) === null || _getFirstItem === void 0 ? void 0 : _getFirstItem.key;
    ...
    constructor(options = {}){
        ...
        super(options);
        this.minItemSize = options.minItemSize || new (0, $IlHAI$Size)(240, 136);
        this.maxItemSize = options.maxItemSize || new (0, $IlHAI$Size)(Infinity, Infinity);
        this.margin = options.margin != null ? options.margin : 24;
        this.minSpace = options.minSpace || new (0, $IlHAI$Size)(18, 18);
...
export {$5ec1ec2c9d2aba1a$export$e9f7cda058ba8df8 as WaterfallLayout};
