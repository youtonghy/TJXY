...
import {Size as $b7Nq3$Size, Rect as $b7Nq3$Rect, LayoutInfo as $b7Nq3$LayoutInfo} from "react-stately/useVirtualizerState";
...
const $871623df43bb31ca$var$DEFAULT_OPTIONS = {
    S: {
        idealRowHeight: 112,
        minItemSize: new (0, $b7Nq3$Size)(96, 96),
        itemSpacing: new (0, $b7Nq3$Size)(8, 16),
        itemPadding: 24,
        dropSpacing: 50,
        margin: 8
    },
...
class $871623df43bb31ca$export$8e52095834484b61 extends (0, $7c753442ee8aa648$export$64943d2e59d72a29) {
    get layoutType() {
        return 'gallery';
    }
    /**
   ...
   */ _distributeWidths(widths) {
    ...
    buildCollection() {
        ...
        if (availableWidth > 0) {
            ...
            let partition = $871623df43bb31ca$var$linearPartition(weightedRatios, rows);
            let index = 0;
            for (let row of partition){
                ...
                for(let j = index; j < index + row.length; j++){
                    ...
                    let rect = new (0, $b7Nq3$Rect)(x, y, itemWidth, itemHeight);
                    let layoutInfo = new (0, $b7Nq3$LayoutInfo)(node.type, node.key, rect);
            ...
            if (this.isLoading) {
                ...
                let rect = new (0, $b7Nq3$Rect)(0, loaderY, visibleWidth, loaderHeight);
                let loader = new (0, $b7Nq3$LayoutInfo)('loader', 'loader', rect);
                this.layoutInfos.set('loader', loader);
                y = loader.rect.maxY;
            }
            if (this.collection.size === 0 && !this.isLoading) {
                let rect = new (0, $b7Nq3$Rect)(0, 0, visibleWidth, visibleHeight);
                let placeholder = new (0, $b7Nq3$LayoutInfo)('placeholder', 'placeholder', rect);
                this.layoutInfos.set('placeholder', placeholder);
                y = placeholder.rect.maxY;
            }
        }
        this.contentSize = new (0, $b7Nq3$Size)(visibleWidth, y);
    }
    constructor(options = {}){
        super(options);
        let cardSize = 'L';
        this.idealRowHeight = options.idealRowHeight || $871623df43bb31ca$var$DEFAULT_OPTIONS[cardSize].idealRowHeight;
        this.itemSpacing = options.itemSpacing || $871623df43bb31ca$var$DEFAULT_OPTIONS[cardSize].itemSpacing;
        this.itemPadding = options.itemPadding != null ? options.itemPadding : $871623df43bb31ca$var$DEFAULT_OPTIONS[cardSize].itemPadding[this.scale];
        this.minItemSize = options.minItemSize || $871623df43bb31ca$var$DEFAULT_OPTIONS[cardSize].minItemSize;
        this.threshold = options.threshold || 1;
        this.margin = options.margin != null ? options.margin : $871623df43bb31ca$var$DEFAULT_OPTIONS[cardSize].margin;
    }
}
// https://www8.cs.umu.se/kurser/TDBA77/VT06/algorithms/BOOK/BOOK2/NODE45.HTM
function $871623df43bb31ca$var$linearPartition(seq, k) {
    let n = seq.length;
    if (k <= 0) return [];
...
export {$871623df43bb31ca$export$8e52095834484b61 as GalleryLayout};
