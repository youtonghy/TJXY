var $b9ec4ce2ddaeda0a$exports = require("./BaseLayout.cjs");
var $9srvW$reactstatelyprivatecollectionsgetChildNodes = require("react-stately/private/collections/getChildNodes");
var $9srvW$reactstatelyuseVirtualizerState = require("react-stately/useVirtualizerState");
...
$parcel$export(module.exports, "GridLayout", function () { return $5965f70f3f9da9cc$export$7d2b12578154a735; });
// @ts-nocheck
/*
...
const $5965f70f3f9da9cc$var$DEFAULT_OPTIONS = {
    S: {
        itemPadding: 20,
        minItemSize: {
        ...
        margin: 8,
        minSpace: new (0, $9srvW$reactstatelyuseVirtualizerState.Size)(6, 6),
        maxColumns: Infinity,
        dropSpacing: 50
    },
    L: {
        ...
        maxItemSize: new (0, $9srvW$reactstatelyuseVirtualizerState.Size)(Infinity, Infinity),
        margin: 24,
        minSpace: new (0, $9srvW$reactstatelyuseVirtualizerState.Size)(18, 18),
        maxColumns: Infinity,
        dropSpacing: 100
    }
};
class $5965f70f3f9da9cc$export$7d2b12578154a735 extends (0, $b9ec4ce2ddaeda0a$exports.BaseLayout) {
    constructor(options = {}){
        super(options);
        let cardSize = 'L';
        this.cardOrientation = options.cardOrientation || 'vertical';
        this.minItemSize = options.minItemSize || $5965f70f3f9da9cc$var$DEFAULT_OPTIONS[cardSize].minItemSize[this.cardOrientation];
        this.maxItemSize = options.maxItemSize || $5965f70f3f9da9cc$var$DEFAULT_OPTIONS[cardSize].maxItemSize;
        this.margin = options.margin != null ? options.margin : $5965f70f3f9da9cc$var$DEFAULT_OPTIONS[cardSize].margin;
        this.minSpace = options.minSpace || $5965f70f3f9da9cc$var$DEFAULT_OPTIONS[cardSize].minSpace;
        this.maxColumns = options.maxColumns || $5965f70f3f9da9cc$var$DEFAULT_OPTIONS[cardSize].maxColumns;
        this.itemPadding = options.itemPadding != null ? options.itemPadding : $5965f70f3f9da9cc$var$DEFAULT_OPTIONS[cardSize].itemPadding[this.cardOrientation][this.scale];
        this.itemSize = null;
        this.numColumns = 0;
        this.numRows = 0;
    ...
    buildCollection() {
        ...
        this.itemSize = new (0, $9srvW$reactstatelyuseVirtualizerState.Size)(itemWidth, itemHeight);
        ...
        if (this.isLoading) {
            ...
            let rect = new (0, $9srvW$reactstatelyuseVirtualizerState.Rect)(0, loaderY, visibleWidth, loaderHeight);
            let loader = new (0, $9srvW$reactstatelyuseVirtualizerState.LayoutInfo)('loader', 'loader', rect);
            this.layoutInfos.set('loader', loader);
            y = loader.rect.maxY;
        }
        if (this.collection.size === 0 && !this.isLoading) {
            let rect = new (0, $9srvW$reactstatelyuseVirtualizerState.Rect)(0, 0, visibleWidth, visibleHeight);
            let placeholder = new (0, $9srvW$reactstatelyuseVirtualizerState.LayoutInfo)('placeholder', 'placeholder', rect);
            this.layoutInfos.set('placeholder', placeholder);
            y = placeholder.rect.maxY;
        }
        this.contentSize = new (0, $9srvW$reactstatelyuseVirtualizerState.Size)(visibleWidth, y);
    }
    buildChild(node, y, index) {
        ...
        let rect = new (0, $9srvW$reactstatelyuseVirtualizerState.Rect)(x, y, this.itemSize.width, this.itemSize.height);
        // TODO: Perhaps have it so that the child key for each row is stored with the layoutInfo?
        let layoutInfo = new (0, $9srvW$reactstatelyuseVirtualizerState.LayoutInfo)(node.type, node.key, rect);
    ...
    getKeyBelow(key) {
        ...
        return row ? (0, $9srvW$reactstatelyprivatecollectionsgetChildNodes.getFirstItem)((0, $9srvW$reactstatelyprivatecollectionsgetChildNodes.getChildNodes)(row, this.collection))?.key : null;
    }
    getKeyAbove(key) {
        // Expected key is the currently focused cell so we need the parent row key
        let parentRowKey = this.collection.getItem(key).parentKey;
