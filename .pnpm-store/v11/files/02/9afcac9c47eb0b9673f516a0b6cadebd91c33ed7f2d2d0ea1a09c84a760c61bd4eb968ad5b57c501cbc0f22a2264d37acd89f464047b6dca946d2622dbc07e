...
import $brclD$react, {createContext as $brclD$createContext, useContext as $brclD$useContext} from "react";
...
const $5d98d27e710cc12e$export$48a76196cafe3b93 = /*#__PURE__*/ (0, $brclD$react).forwardRef(function Resizer(props, ref) {
    ...
    let { inputProps: inputProps, resizerProps: resizerProps, isMouseResizing: isMouseResizing } = (0, $brclD$useTableColumnResize)((0, $brclD$mergeProps)(props, {
