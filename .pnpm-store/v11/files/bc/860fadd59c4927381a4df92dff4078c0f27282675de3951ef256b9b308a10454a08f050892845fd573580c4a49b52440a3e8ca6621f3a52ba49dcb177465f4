...
import "./overlays.css";
import $kZLBk$overlays_cssmjs from "./overlays_css.mjs";
import "../popover_vars.css";
import $kZLBk$popover_vars_cssmjs from "../popover_vars_css.mjs";
...
import {usePopover as $kZLBk$usePopover} from "react-aria/usePopover";
import {DismissButton as $kZLBk$DismissButton} from "react-aria/Overlay";
import {useFocusWithin as $kZLBk$useFocusWithin} from "react-aria/useFocusWithin";
import {mergeProps as $kZLBk$mergeProps} from "react-aria/mergeProps";
import $kZLBk$react, {forwardRef as $kZLBk$forwardRef, useRef as $kZLBk$useRef, useState as $kZLBk$useState} from "react";
import {useLayoutEffect as $kZLBk$useLayoutEffect} from "react-aria/private/utils/useLayoutEffect";
import {useObjectRef as $kZLBk$useObjectRef} from "react-aria/useObjectRef";
 ...
 */ let $3a473e3b7032f626$var$arrowPlacement = {
    left: 'right',
    right: 'right',
    top: 'bottom',
    bottom: 'bottom'
};
const $3a473e3b7032f626$export$5b6b19405a83ff9d = /*#__PURE__*/ (0, $kZLBk$forwardRef)(function Popover(props, ref) {
    let { children: children, state: state, ...otherProps } = props;
    let domRef = (0, $3c2c983d5210446c$export$c2c55ef9111cafd8)(ref);
    let wrapperRef = (0, $kZLBk$useRef)(null);
    return /*#__PURE__*/ (0, $kZLBk$react).createElement((0, $90fcff6c53c7cf60$export$c6fdb837b070b4ff), {
        ...otherProps,
        isOpen: state.isOpen,
        nodeRef: wrapperRef
    }, /*#__PURE__*/ (0, $kZLBk$react).createElement($3a473e3b7032f626$var$PopoverWrapper, {
        ref: domRef,
        ...props,
        wrapperRef: wrapperRef
    }, children));
});
const $3a473e3b7032f626$var$PopoverWrapper = /*#__PURE__*/ (0, $kZLBk$forwardRef)((props, ref)=>{
    ...
    let objRef = (0, $kZLBk$useObjectRef)(ref);
    let { size: size, borderWidth: borderWidth, arrowRef: arrowRef } = $3a473e3b7032f626$var$useArrowSize();
    const borderRadius = $3a473e3b7032f626$var$usePopoverBorderRadius(objRef);
    let borderDiagonal = borderWidth * Math.SQRT2;
    let primary = size + borderDiagonal;
    let secondary = primary * 2;
    let { popoverProps: popoverProps, arrowProps: arrowProps, underlayProps: underlayProps, placement: placement } = (0, $kZLBk$usePopover)({
        ...props,
        popoverRef: objRef,
        maxHeight: undefined,
    ...
    let { focusWithinProps: focusWithinProps } = (0, $kZLBk$useFocusWithin)(props);
    ...
    return /*#__PURE__*/ (0, $kZLBk$react).createElement("div", {
        ref: wrapperRef
    }, !isNonModal && /*#__PURE__*/ (0, $kZLBk$react).createElement((0, $9d27f060fca68ae8$export$f360afc887607b02), {
        isTransparent: true,
        ...(0, $kZLBk$mergeProps)(underlayProps),
        isOpen: isOpen
    }), /*#__PURE__*/ (0, $kZLBk$react).createElement("div", {
        ...styleProps,
        ...(0, $kZLBk$mergeProps)(popoverProps, focusWithinProps),
        style: {
            ...styleProps.style,
            ...popoverProps.style
        },
        ref: objRef,
        className: (0, $6e6392558d48dfec$export$ce4ab0c55987d1ff)((0, ($parcel$interopDefault($kZLBk$popover_vars_cssmjs))), 'spectrum-Popover', `spectrum-Popover--${placement}`, {
            'spectrum-Popover--withTip': !hideArrow,
            'is-open': isOpen,
            [`is-open--${placement}`]: isOpen,
            'is-exiting': !state.isOpen
        }, (0, $6e6392558d48dfec$export$ce4ab0c55987d1ff)((0, ($parcel$interopDefault($kZLBk$overlays_cssmjs))), 'spectrum-Popover', 'react-spectrum-Popover'), styleProps.className),
        role: "presentation",
        "data-testid": "popover"
    }, (!isNonModal || enableBothDismissButtons) && /*#__PURE__*/ (0, $kZLBk$react).createElement((0, $kZLBk$DismissButton), {
        onDismiss: onDismissButtonPress
    }), children, hideArrow ? null : /*#__PURE__*/ (0, $kZLBk$react).createElement($3a473e3b7032f626$var$Arrow, {
        arrowProps: arrowProps,
        isLandscape: placement != null ? $3a473e3b7032f626$var$arrowPlacement[placement] === 'bottom' : false,
        arrowRef: arrowRef,
        primary: primary,
        secondary: secondary,
        borderDiagonal: borderDiagonal
    }), /*#__PURE__*/ (0, $kZLBk$react).createElement((0, $kZLBk$DismissButton), {
        onDismiss: onDismissButtonPress
    })));
});
function $3a473e3b7032f626$var$usePopoverBorderRadius(popoverRef) {
    let [borderRadius, setBorderRadius] = (0, $kZLBk$useState)(0);
    (0, $kZLBk$useLayoutEffect)(()=>{
...
function $3a473e3b7032f626$var$useArrowSize() {
    let [size, setSize] = (0, $kZLBk$useState)(20);
    let [borderWidth, setBorderWidth] = (0, $kZLBk$useState)(1);
    let arrowRef = (0, $kZLBk$useRef)(null);
...
function $3a473e3b7032f626$var$Arrow(props) {
    ...
    /* use ceil because the svg needs to always accommodate the path inside it */ return /*#__PURE__*/ (0, $kZLBk$react).createElement("svg", {
        xmlns: "http://www.w3.org/svg/2000",
        width: Math.ceil(isLandscape ? secondary : primary),
        height: Math.ceil(isLandscape ? primary : secondary),
        className: (0, $6e6392558d48dfec$export$ce4ab0c55987d1ff)((0, ($parcel$interopDefault($kZLBk$popover_vars_cssmjs))), 'spectrum-Popover-tip'),
        ref: arrowRef,
        ...arrowProps
    }, /*#__PURE__*/ (0, $kZLBk$react).createElement("path", {
        className: (0, $6e6392558d48dfec$export$ce4ab0c55987d1ff)((0, ($parcel$interopDefault($kZLBk$popover_vars_cssmjs))), 'spectrum-Popover-tip-triangle'),
        d: pathData.join(' ')
    }));
} /**
...
export {$3a473e3b7032f626$export$5b6b19405a83ff9d as Popover};
